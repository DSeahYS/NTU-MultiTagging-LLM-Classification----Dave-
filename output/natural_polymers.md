# natural_polymers
**Domain**: Biomaterial & Bioink Chemistry
**Total Papers**: 37

---

- 3D bioprinted breast tumor-stroma models for pre-clinical drug testing.pdf
...
- Advances in 3D bioprinting for modeling the blood-brain barrier in neurodegenera.pdf
...
- Automated and dynamic extrusion pressure adjustment based on real-time flow rate.pdf
...
- Ultra-small tissue-compatible organoid printer for rapid and controllable modeli.pdf
